...
RayStruct++ is a C++ desktop application for visualizing data structures and algorithms in an interactive and educational way. Built with the lightweight raylib graphics library, the application provides real-time animated visualizations that make abstract computing concepts easier to understand.
...
Animated visualizations with highlights and transitions

Step-by-step execution of algorithms for learning and debugging

Support for custom user-defined code (upload your own structures and algorithms)
...
Binary Tree: BFS, Inorder Traversal, Deletion
